        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-sm text-ink-muted">
              Structural Engineering · Steel Design · Python & AI · Investing
            </p>
          </div>

          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-ink-muted">Navigation</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-ink-muted">Connect</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-ink-muted">Newsletter</h3>
            <p className="mt-3 text-sm text-ink-muted">
              Get updates on new posts and projects. No spam.
            </p>
            <Link
